  ...
  {canViewFinancials && (
    ...
    />
      ...
      <section className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            ...
            <span className="font-bold text-slate-900">Ver Deudores</span>
          </button>
      ...
      <div className="grid xl:grid-cols-2 gap-6">
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between px-1">
            <h3 className="text-lg font-bold text-slate-900">Top Deudores</h3>
            <button
              onClick={() => onNavigate('defaulters')}
              className="text-sm font-bold text-indigo-600 flex items-center gap-1"
            >
              ...
              {topDefaulters.length > 0 ? (
                topDefaulters.map((student: any) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      <p className="font-bold text-slate-900">${student.debtDisplay || 0}</p>
                    </div>
                  </div>
                ))
              ) : (
