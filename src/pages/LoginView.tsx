    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center space-y-2">
          <div className="w-20 h-20 bg-slate-900 rounded-3xl flex items-center justify-center text-white text-4xl font-black italic mx-auto shadow-2xl shadow-slate-200 mb-6">
            G
          </div>
          <h1 className="text-3xl font-black tracking-tighter text-slate-900 italic">GIMNASIO PRO</h1>
          <p className="text-slate-500 font-medium">Gestioná tu gimnasio como un profesional.</p>
        </div>
        ...
        <div className="text-center">
          <p className="text-sm text-slate-500">
            ¿No tenés cuenta? <button onClick={onRegisterClick} className="font-bold text-slate-900 hover:underline">Registrá tu gimnasio</button>
          </p>
        </div>
      </div>
    </div>
